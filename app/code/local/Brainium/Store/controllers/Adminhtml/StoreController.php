...
class Brainium_Store_Adminhtml_StoreController extends Mage_Adminhtml_Controller_Action {
    ...
    public function saveAction() {
        if ($data = $this->getRequest()->getPost()) {
            ...
            if (isset($_FILES['image']['name']) && $_FILES['image']['name'] != '') {
                try {
                    ...
                    $path = Mage::getBaseDir('media') . DS . 'store' . DS;
            ...
            try {
                ...
                $model->save();
                Mage::getSingleton('adminhtml/session')->addSuccess(Mage::helper('store')->__('Item was successfully saved'));
        ...
        Mage::getSingleton('adminhtml/session')->addError(Mage::helper('store')->__('Unable to find item to save'));
        $this->_redirect('*/*/');
    }
    ...
    public function massStatusAction() {
        ...
        if (!is_array($storeIds)) {
            ...
            try {
                foreach ($storeIds as $storeId) {
                    $store = Mage::getSingleton('store/store')
                            ->load($storeId)
