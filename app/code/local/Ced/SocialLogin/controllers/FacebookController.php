...

{
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('ced_sociallogin/facebook')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $customersByFacebookId = Mage::helper('ced_sociallogin/facebook')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('ced_sociallogin/facebook')->connectByFacebookId(
            ...
            if($customersByFacebookId->count()) {
                ...
                Mage::helper('ced_sociallogin/facebook')->loginByCustomer($customer);
            ...
            $customersByEmail = Mage::helper('ced_sociallogin/facebook')
            ...
            Mage::helper('ced_sociallogin/facebook')->connectByCreatingAccount(
