 ...
 * @author 		CedCommerce Core Team <coreteam@cedcommerce.com>
 */
class Ced_SocialLogin_Model_Feed extends Mage_AdminNotification_Model_Feed
{
    ...
    {	
		$cedModules = Mage::helper('ced_sociallogin')->getCedCommerceExtensions();
        ...
        $feedXml = $this->getFeedData(Mage::helper('ced_sociallogin')->getEnvironmentInformation());
        ...
        if ($feedXml && $feedXml->channel && $feedXml->channel->item) {
			...
			foreach ($feedXml->channel->item as $item) {
				if(Mage::helper('ced_sociallogin')->isAllowedFeedType($item)) {
