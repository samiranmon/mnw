...
class Ced_SocialLogin_TwitterController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('ced_sociallogin/twitter')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        $customersByTwitterId = Mage::helper('ced_sociallogin/twitter')
        ...
        if(Mage::getSingleton('customer/session')->isLoggedIn()) {
            ...
            Mage::helper('ced_sociallogin/twitter')->connectByTwitterId(
                $customer,
                $userInfo->id,
                $token
            );
        ...
        if($customersByTwitterId->count()) {
            ...
            Mage::helper('ced_sociallogin/twitter')->loginByCustomer($customer);
        ...
        $customersByEmail = Mage::helper('ced_sociallogin/twitter')
        ...
        Mage::helper('ced_sociallogin/twitter')->connectByCreatingAccount(
            $userInfo->email,
            $userInfo->name,
            $userInfo->id,
            $token
