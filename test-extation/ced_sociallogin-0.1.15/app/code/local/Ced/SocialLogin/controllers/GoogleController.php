...
class Ced_SocialLogin_GoogleController extends Mage_Core_Controller_Front_Action
{
    ...
    protected function _disconnectCallback(Mage_Customer_Model_Customer $customer) {
        ...
        Mage::helper('ced_sociallogin/google')->disconnect($customer);
    ...
    protected function _connectCallback() {
        ...
        if ($code) {
            ...
            $customersByGoogleId = Mage::helper('ced_sociallogin/google')
            ...
            if(Mage::getSingleton('customer/session')->isLoggedIn()) {
                ...
                Mage::helper('ced_sociallogin/google')->connectByGoogleId(
                    $customer,
                    $userInfo->id,
                    $token
                );
            ...
            if($customersByGoogleId->count()) {
                ...
                Mage::helper('ced_sociallogin/google')->loginByCustomer($customer);
            ...
            Mage::helper('ced_sociallogin/google')->connectByCreatingAccount(
                $userInfo->email,
                $userInfo->given_name,
